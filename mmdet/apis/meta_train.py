...
from mmdet.core import (DistEvalHook, DistOptimizerHook, EvalHook, DistMetaEvalHook,
...
def _dist_train(model,
    ...
    if validate:
        ...
        # pre test
        cfg.data.support.test_mode = True
        cfg.data.support.pre_test = True
        support_dataset = build_dataset(cfg.data.support, dict(test_mode=True))
        support_dataloader = build_dataloader(
            support_dataset,
            imgs_per_gpu=1,
        ...
        runner.register_hook(DistMetaEvalHook(val_dataloader, support_dataloader=support_dataloader, **eval_cfg))
