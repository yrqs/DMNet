...
class GADMLRPN1Head(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLRPN1Head, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def forward_single(self, x):
        ...
        feat_cls = self.feature_adaption_cls(x, shape_pred)
        feat_reg = self.feature_adaption_reg(x, shape_pred)
        ...
        if self.training:
            reps = self.rep(torch.tensor(1.0).to(feat_cls.device).unsqueeze(0)).squeeze(0)
