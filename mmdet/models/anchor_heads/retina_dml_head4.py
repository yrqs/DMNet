...
class FeatureAdaption(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_offset = nn.Conv2d(
            conv_offset_in_channels, deformable_groups * offset_channels, 1, bias=False)
...
class RetinaDMLHead4(AnchorHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 stacked_convs=4,
    ...
    def forward_single(self, x):
        ...
        cls_feat = self.feature_adaption(cls_feat, bbox_pred)
