...
class GARetinaDMLHead16D(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(GARetinaDMLHead16D, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def forward_single(self, x):
        ...
        loc_pred = torch.ones([cls_feat.size(0), 1, cls_feat.size(-2), cls_feat.size(-1)]).to(cls_feat.device)
    ...
    def forward(self, feats):
        if self.training:
            ...
            if self.save_outs:
                ...
                save_idx = 1
                save_path_base = 'mytest/ga_retina_dml16D_feature.pth'
