...
class GADMLRPN3Head(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLRPN3Head, self).__init__(num_classes, in_channels, **kwargs)
        self.loss_emb = build_loss(loss_emb)
    def _init_layers(self):
        self.relu = nn.ReLU(inplace=True)
        self.rpn_conv = nn.Conv2d(self.in_channels, self.feat_channels, 3, padding=1)
        self.rpn_conv1 = nn.Conv2d(self.feat_channels, self.feat_channels, 3, padding=1)
