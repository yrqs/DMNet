...
class GARetinaDMLHead8(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(GARetinaDMLHead8, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.feature_adaption_reg = nn.Conv2d(self.feat_channels, self.feat_channels, 3, stride=1, padding=1)
    ...
    def forward_single(self, x):
        ...
        if self.save_outs:
            ...
            feat_reg = self.feature_adaption_reg(reg_feat)
