...
class GADMLRPN4Head(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLRPN4Head, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def init_weights(self):
        ...
        constant_init(self.emb_weights, 1e-30)
    ...
    def forward_single(self, x):
        ...
        distances = torch.sqrt((((distances - reps)**2)*self.emb_weights.sigmoid()).sum(-1)).permute(0, 3, 4, 1, 2).contiguous()
    ...
    def loss_emb_single(self, distance, label, label_weights, num_total_samples):
        ...
        loss_emb = self.loss_emb(
            ...
            # avg_factor=max(1, int(distance.size(1)))//10)
        return loss_emb
