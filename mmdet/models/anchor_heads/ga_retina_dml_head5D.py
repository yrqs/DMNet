...
class GARetinaDMLHead5D(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(GARetinaDMLHead5D, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.feature_adaption_cls = FeatureAdaptionCls(
            ...
            self.feat_channels,
            kernel_size=3,
            conv_offset_in_channels=self.feat_channels,
            conv_offset_kernel_size=3,
    ...
    def forward_single(self, x):
        ...
        feat_cls = self.feature_adaption_cls(cls_feat, cls_feat)
