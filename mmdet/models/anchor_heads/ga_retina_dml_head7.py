...
class GARetinaDMLHead7(GuidedAnchorHead):
    ...
    def _init_layers(self):
        ...
        self.feature_adaption_cls = nn.Conv2d(self.feat_channels, self.feat_channels, 3, 1, 1)
        self.feature_adaption_reg = nn.Conv2d(self.feat_channels, self.feat_channels, 3, 1, 1)
    ...
    def init_weights(self):
        ...
        normal_init(self.feature_adaption_cls, std=0.01, bias=bias_cls)
        normal_init(self.feature_adaption_reg, std=0.01)
    ...
    def forward_single(self, x):
        ...
        cls_feat_adp = self.feature_adaption_cls(cls_feat)
        reg_feat_adp = self.feature_adaption_reg(reg_feat)
