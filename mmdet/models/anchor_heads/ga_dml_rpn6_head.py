...
class GADMLRPN6Head(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLRPN6Head, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        # self.emb_weights = nn.Parameter(torch.randn(1, 1, 1, 1, 1, self.emb_sizes[-1]))
    ...
    def forward_single(self, x):
        ...
        if self.training:
            if self.finetuning:
                return cls_score, bbox_pred, shape_pred, loc_pred, emb_vectors
            else:
