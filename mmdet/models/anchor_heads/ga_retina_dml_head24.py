...
class GARetinaDMLHead24(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(GARetinaDMLHead24, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.cls_feat_enhance = nn.Sequential(
            ...
            nn.Conv2d(self.feat_channels//16, self.deformable_groups, 3, stride=1, padding=1),
        )
    ...
    def init_weights(self):
        ...
        for m in self.cls_feat_enhance:
            normal_init(m, std=0.01)
