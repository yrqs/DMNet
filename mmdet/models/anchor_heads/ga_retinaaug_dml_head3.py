...
class GARetinaAugDMLHead3(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        self.loss_aug_weight = loss_aug_weight
        super(GARetinaAugDMLHead3, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss(self,
        ...
        for i in range(len(cls_scores_ex)):
            if cls_scores_ex[i] is not None:
                loss_cls_ex = self.loss_cls_ex_single(
                    ...
                    labels_list[i],
                    label_weights_list[i])
                losses_cls_ex.append(loss_cls_ex*self.loss_aug_weight)
        ...
        for i in range(len(distances_ex)):
            if distances_ex[i] is not None:
                ...
                losses_emb_ex.append(loss_emb*self.loss_aug_weight)
