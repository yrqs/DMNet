...
class GARetinaDMLHead17D(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(GARetinaDMLHead17D, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def forward_single(self, x):
        ...
        objectness = loc_pred.sigmoid()
        probs_fg = probs_fg * objectness
        probs_bg = probs_bg * torch.sub(1, objectness)
