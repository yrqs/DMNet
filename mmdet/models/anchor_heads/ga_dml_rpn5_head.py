...
from .guided_anchor_head import FeatureAdaption, GuidedAnchorHead, FeatureAdaption1
...
class GADMLRPN5Head(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLRPN5Head, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        #     kernel_size=3,
        #     deformable_groups=self.deformable_groups)
        # self.feature_adaption = FeatureAdaption1(
        #     self.feat_channels,
        #     self.feat_channels,
        #     kernel_size=3,
        #     deformable_groups=self.deformable_groups)
    ...
    def forward_single(self, x):
        ...
        # feat_cls = self.feature_adaption(x, shape_pred_cls)
        # feat_reg = self.feature_adaption(x, shape_pred_reg)
