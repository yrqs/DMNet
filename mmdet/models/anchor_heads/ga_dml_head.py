...
class GADMLHead(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GADMLHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def forward_single(self, x):
        ...
        if self.training:
            reps = self.rep(torch.tensor(1.0).to(cls_feat.device).unsqueeze(0)).squeeze(0)
