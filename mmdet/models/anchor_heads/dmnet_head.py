...
from mmdet.core import (anchor_target, delta2bbox, force_fp32, ga_loc_target, ga_shape_target,
...
class FeatureAdaptionReg(nn.Module):
    """Feature Adaption Module.
    ...
    def __init__(self,
                 ...
                 kernel_size=3,
                 deformable_groups=4):
        super(FeatureAdaptionReg, self).__init__()
        offset_channels = kernel_size * kernel_size * 2
        self.conv_offset = nn.Conv2d(
...
class DMNetHead(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        self.sigma = sigma
        super(DMNetHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.feature_adaption_reg = FeatureAdaptionReg(
            self.feat_channels,
            self.feat_channels,
            kernel_size=3,
            deformable_groups=self.deformable_groups)
