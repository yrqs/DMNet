...
class GARetinaDMLHead2D(GuidedAnchorHead):
    ...
    def __init__(self,
        ...
        super(GARetinaDMLHead2D, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def forward(self, feats):
        if self.training:
            ...
            if self.save_outs:
                ...
                save_idx = 1
                save_path_base = 'mytest/ga_retina_dml2D_feature.pth'
