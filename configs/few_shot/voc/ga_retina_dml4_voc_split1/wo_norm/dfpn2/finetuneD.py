...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_loc=dict(
            ...
            alpha=0.25,
            loss_weight=0.1),
        loss_shape=dict(type='BoundedIoULoss', beta=0.2, loss_weight=0.1),
        loss_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
...
load_from = 'work_dirs/ga_retina_dml4_voc_split1/wo_norm/dfpn2/base/epoch_16.pth'
resume_from = None
workflow = [('train', 1)]
