...
model = dict(
    type='RetinaNet',
    pretrained='/home/luyue/.cache/torch/checkpoints/resnet101-5d3b4d8f_wo_res5.pth',
    backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
load_from = 'work_dirs/ga_retina_dml4_voc_split1/wo_norm/wo_res5_pre/base/epoch_16.pth'
resume_from = None
workflow = [('train', 1)]
