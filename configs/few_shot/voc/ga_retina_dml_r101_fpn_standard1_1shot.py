...
# optimizer
optimizer = dict(type='SGD', lr=0.000125*1*1, momentum=0.9, weight_decay=0.0001)
...
load_from = 'work_dirs/ga_retina_dml_emb1024_256_alpha015_le025_voc_base1_r1_lr_lr00025x2x4_8_14_18/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
