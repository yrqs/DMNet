...
# dataset settings
dataset_type = 'MetaVOCDatasetBase{}'.format(split_num)
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=[
                ...
                # data_root + 'VOC2007/ImageSets/Main/trainval_' + '1' + 'shot_novel_standard.txt',
                # data_root + 'VOC2012/ImageSets/Main/trainval_' + '1' + 'shot_novel_standard.txt'
            ],
    ...
    support=dict(
        ...
        img_prefix=[data_root + 'VOC2007/', data_root + 'VOC2012/'],
        # ann_file=data_root + 'VOC2007/ImageSets/Main/trainval_' + '1' + 'shot_novel_standard.txt',
