...
train_repeat_times = [50, 30, 20, 6, 3][shot_idx]
freeze = True
freeze1 = False
...
# optimizer
optimizer = dict(type='SGD', lr=0.0005*2*2, momentum=0.9, weight_decay=0.0001)
...
load_from = 'work_dirs/ga_retina_r101_voc_base1_r1_lr00125x2x1_8_11_12/epoch_12.pth'
# load_from = 'work_dirs/ga_retina_r101_voc_base1_r1_lr00125x2x1_8_11_12/epoch_12_init_head.pth'
resume_from = None
workflow = [('train', 1)]
