...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.10, nms=dict(type='nms', iou_thr=0.3), max_per_img=100))
# dataset settings
...
load_from = 'work_dirs/frcn_r101_voc/fs_cos_bbox_head/rep_key_channel/split2/base/epoch_14.pth'
resume_from = None
workflow = [('train', 1)]
