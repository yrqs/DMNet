...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.11, nms=dict(type='nms', iou_thr=0.5), max_per_img=100))
# dataset settings
...
load_from = 'work_dirs/frcn_r101_voc/fs_cos_neg_bbox_head1/hn_thresh_02/split2/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
