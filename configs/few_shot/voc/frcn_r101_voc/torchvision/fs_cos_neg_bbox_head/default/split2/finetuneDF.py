...
model = dict(
    ...
    bbox_roi_extractor=dict(
        ...
        featmap_strides=[16]),
    bbox_head=dict(
        type='FSCosNegBBoxHead',
        neg_num_modes=3,
        beta=0.3,
        neg_thresh=0.2,
        neg_margin=0.1,
        loss_hn_pos_weight=1.,
        loss_hn_neg_weight=1.,
        triplet_margin=0.1,
...
load_from = 'work_dirs/frcn_r101_voc/torchvision/fs_cos_neg_bbox_head/default/split2/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
