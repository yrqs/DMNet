...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.05, nms=dict(type='nms', iou_thr=0.9999), max_per_img=100))
# dataset settings
dataset_type = 'VOCDataset'
# dataset_type = 'VOCDatasetNovel1'
...
load_from = 'work_dirs/frcn_r101_voc_split1/torchvision/fs_bbox_head/wo_detach/1000_600/use_cos/triplet_loss/margin_01/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
