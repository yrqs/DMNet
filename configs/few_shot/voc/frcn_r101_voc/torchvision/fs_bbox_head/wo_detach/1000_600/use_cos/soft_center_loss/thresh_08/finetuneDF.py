...
model = dict(
    ...
    bbox_head=dict(
        type='FSBBoxHead',
        add_soft_cos_center_loss=True,
        soft_center_thresh=0.8,
        use_cos=True,
        cos_scale=20,
        freeze_att=True,
        detach=False,
...
load_from = 'work_dirs/frcn_r101_voc_split1/torchvision/fs_bbox_head/wo_detach/1000_600/use_cos/soft_center_loss/thresh_08/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
