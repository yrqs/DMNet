...
model = dict(
    ...
    bbox_head=dict(
        ...
        freeze_channel_attention=True,
        channel_attention_loss_weight=1e-4,
        grad_scale=0.001,
        detach=False,
        freeze_att=True,
        with_avg_pool=True,
...
load_from = 'work_dirs/frcn_r101_voc_split1/torchvision/fs_bbox_head/wo_detach/1000_600/l1_channel_attention/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
