...
model = dict(
    ...
    bbox_head=dict(
        ...
        use_cos=True,
        cos_scale=20,
        add_cos_center_loss=True,
        cos_center_loss_weight=0.5,
        grad_scale=0.001,
        detach=False,
        freeze_att=True,
        with_avg_pool=True,
...
load_from = 'work_dirs/frcn_r101_voc_split1/torchvision/fs_bbox_head/wo_detach/1000_600/use_cos/loss_center/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
