shot = 1
shot_idx = [1, 2, 3, 5, 10]
train_repeat_times = [10, 25, 20, 15, 10]
...
model = dict(
    ...
    bbox_head=dict(
        type='BBoxHead',
        enhance_hn=True,
        enhance_hn_thresh=0.05,
        enhance_hn_weight=0.1,
        grad_scale=0.001,
        with_avg_pool=True,
        roi_feat_size=7,
        in_channels=2048,
...
load_from = 'work_dirs/frcn_r101_voc/torchvision/1000_600/enhance_hn/split2/base/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
