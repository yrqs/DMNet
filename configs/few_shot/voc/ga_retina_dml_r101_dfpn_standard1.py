...
train_repeat_times = [50, 30, 10, 6, 3][shot_idx]
freeze = True
freeze1 = False
...
# optimizer
optimizer = dict(type='SGD', lr=0.0000125*2*2, momentum=0.9, weight_decay=0.0001)
...
load_from = 'work_dirs/ga_retina_dml_dfpn_emb1024_256_alpha015_le025_voc_base1_r1_lr00025x2x2_12_16_18/epoch_12_init_rep.pth'
resume_from = None
workflow = [('train', 1)]
