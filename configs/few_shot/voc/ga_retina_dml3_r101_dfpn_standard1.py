...
# optimizer
optimizer = dict(type='SGD', lr=0.00005*2*1, momentum=0.9, weight_decay=0.0001)
...
load_from = 'work_dirs/ga_retina_dml3_s2_dfpn_emb256_64_alpha015_le10_CE_nratio3_voc_base1_r1_lr00025x2x2_10_14_16_ind1_1/epoch_16.pth'
resume_from = None
workflow = [('train', 1)]
