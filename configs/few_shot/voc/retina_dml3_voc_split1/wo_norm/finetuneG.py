...
train_repeat_times = [20, 20, 20, 15, 10][shot_idx]
freeze = False
freeze1 = False
neg_pos_ratio = 3
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                data_root + 'VOC2007/ImageSets/Main/seedn/trainval_nshot_novel_standard.txt',
                data_root + 'VOC2012/ImageSets/Main/seedn/trainval_nshot_novel_standard.txt'
            ],
...
checkpoint_config = dict(interval=lr_step[2]+1)
# yapf:disable
log_config = dict(
    interval=50,
    hooks=[
...
load_from = 'work_dirs/retina_dml3_voc_split1/wo_norm/base/epoch_16.pth'
resume_from = None
workflow = [('train', 1)]
