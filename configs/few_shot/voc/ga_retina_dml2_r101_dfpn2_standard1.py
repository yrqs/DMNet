...
train_repeat_times = [50, 25, 20, 6, 3][shot_idx]
freezeB = False
freeze = False
freeze1 = False
neg_pos_ratio = 8
...
[
    ...
    dict(type='LoadAnnotations', with_bbox=True),] + \
                 ([dict(type='Expand'),
                   dict(type='MinIoURandomCrop')] if aug else []) + \
...
# load_from = 'work_dirs/ga_retina_dml2_dfpn2_emb256_64_alpha015_le10_CE_nratio3_voc_base1_r1_lr00025x2x2_10_14_16_ind1/epoch_16.pth'
load_from = 'work_dirs/ga_retina_dml2_dfpn2_emb256_64_alpha015_le10_CE_nratio3_voc_base1_r1_lr00025x2x1_12_14_16_ind2_1/epoch_16.pth'
resume_from = None
workflow = [('train', 1)]
