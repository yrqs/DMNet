...
# optimizer
optimizer = dict(type='SGD', lr=0.000125*2*2, momentum=0.9, weight_decay=0.0001)
...
load_from = 'work_dirs/ga_retina_dml_fpn_emb1024_256_alpha015_le025_coco_base1_r1_lr000125x2x4_10_14_16/epoch_12_init_rep.pth'
resume_from = None
workflow = [('train', 1)]
