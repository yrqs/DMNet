...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_loc=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_shape=dict(type='BoundedIoULoss', beta=0.12, loss_weight=1.0),
        # loss_cls=dict(
        #     type='FocalLoss',
        #     use_sigmoid=False,
        #     gamma=2.0,
...
# load_from = 'work_dirs/ga_dml_rpn_x101_uw20_embsize128_alpha015_lr0005-7-11-13_CE_ind1_beta004_tloss/epoch_13.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
