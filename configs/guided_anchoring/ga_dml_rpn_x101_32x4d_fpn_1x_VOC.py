...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_emb=dict(type='RepMetLoss', loss_weight=1.0)))
...
evaluation = dict(interval=4, metric='mAO')
...
# load_from = 'work_dirs/ga_dml_retina_x101_ind1_uw20_embsize256/epoch_1.pth'
# resume_from = 'work_dirs/ga_dml_retina_x101_ind1_uw20_embsize256/epoch_1.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
