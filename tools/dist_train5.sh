...
PARAMETER=torchvision/fs_bbox_head2/1000_600/split2
...
#    --validate \
#    --shot $i \
#    --work_dir $WORK_DIR_BASE'DF/'$i'shot' \
#    && sleep 20s
#done;
#
...
#    --validate \
#    --shot $i \
#    --work_dir $WORK_DIR_BASE'DFCrop/'$i'shot' \
#    && sleep 20s
#done;
...
#PARAMETER=torchvision/fs_bbox_head/wo_detach/1000_600/aug2
#
#CONFIG_PATH='configs/few_shot/'$DATASET'/'$MODEL_NAME'/'$PARAMETER'/'
#WORK_DIR_BASE='work_dirs/'$MODEL_NAME'/'$PARAMETER'/'
#PORT=${PORT:-27500}
