...
#CONFIG=configs/few_shot/voc/ga_retina_dmlneg3_nscope20_nalpha01_nthre02_r101_fpn_standard1/base.py
#GPUS=4
#PORT=${PORT:-27500}
#OMP_NUM_THREADS=4 \
...
WORK_DIR_BASE='work_dirs/ga_retina_dmlneg3_nscope20_nalpha01_nthre02_voc_standard1_ind2'
