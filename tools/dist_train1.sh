...
CONFIG=configs/few_shot/voc/ga_retina_dmlneg3_nscope20_nalpha01_nthre03_r101_fpn_standard2/base.py
GPUS=8
PORT=${PORT:-27500}
OMP_NUM_THREADS=4 \
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYTHON -m torch.distributed.launch --nproc_per_node=$GPUS --master_port=$PORT \
    ...
    --validate \
    --work_dir 'work_dirs/ga_retina_nscope20_nalpha01_nthre03_voc_base2'
