...
CONFIG=configs/few_shot/voc/ga_retina_dmlneg6_nscope20_nalpha01_nthre02_r101_fpn_standard2/base.py
CHECKPOINT=work_dirs/ga_retina_dmlneg6_nscope20_nalpha01_nthre02_voc_base2/epoch_16.pth
GPUS=1
PORT=${PORT:-79500}
